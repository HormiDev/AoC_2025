...
/*   Updated: 2025/12/01 20:59:34 by ide-dieg         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(int argc, char **argv)
{
	...
	//ft_printf("Current dial: %d Zero count: %d\n", dial, zero_count);
	while (current_line)
	{
		...
		//ft_printf("Current dial: %d Zero count: %d Direction: %s", dial, zero_count, current_line->str);
